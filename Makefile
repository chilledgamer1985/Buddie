...
pkgdatadir = $(datadir)/buddiecore
pkgincludedir = $(includedir)/buddiecore
pkglibdir = $(libdir)/buddiecore
pkglibexecdir = $(libexecdir)/buddiecore
...
CONFIG_HEADER = $(top_builddir)/src/config/buddie-config.h
CONFIG_CLEAN_FILES = libbuddieconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libbuddieconsensus.pc.in \
	...
	$(top_srcdir)/src/config/buddie-config.h.in \
...
ACLOCAL = ${SHELL} /home/ben/swamp/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ben/swamp/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ben/swamp/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ben/swamp/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/ben/swamp/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = buddiecore
PACKAGE_BUGREPORT = https://github.com/buddiecoin/buddie/issues
PACKAGE_NAME = Buddie Core
PACKAGE_STRING = Buddie Core 2.0.0
PACKAGE_TARNAME = buddiecore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/ben/swamp
abs_srcdir = /home/ben/swamp
abs_top_builddir = /home/ben/swamp
abs_top_srcdir = /home/ben/swamp
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ben/swamp/build-aux/install-sh
...
pkgconfig_DATA = libbuddieconsensus.pc
BITCOIND_BIN = $(top_builddir)/src/buddied$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/buddie-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/buddie-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Buddie-Qt.app
OSX_DMG = Buddie-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_buddie_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_buddie_coverage.info test_buddie.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Buddie-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/buddie-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/buddie-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/buddie-config.h
$(top_srcdir)/src/config/buddie-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/buddie-config.h src/config/stamp-h1
libbuddieconsensus.pc: $(top_builddir)/config.status $(srcdir)/libbuddieconsensus.pc.in
...
$(OSX_APP)/Contents/MacOS/Buddie-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Buddie-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Buddie-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Buddie-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_buddie.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_buddie -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_buddie_filtered.info: test_buddie.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_buddie_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_buddie_filtered.info
...
#test_buddie_coverage.info: baseline_filtered_combined.info test_buddie_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_buddie_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_buddie_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_buddie_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_buddie.coverage/.dirstamp:  test_buddie_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_buddie.coverage/.dirstamp total.coverage/.dirstamp

# Buddie: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_buddie.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
