...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Buddie related functionality
...
/*
    ...
    allow endless transaction that would bloat Buddie and make it unusable. To
