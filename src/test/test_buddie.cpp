...
#define BOOST_TEST_MODULE Buddie Test Suite

#include "test_buddie.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_buddie_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
