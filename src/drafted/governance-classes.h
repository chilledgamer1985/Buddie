 ...
 *
 *   // network
 *   CBuddieNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.buddie.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBuddieNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BuddieNetwork
// //   -- signature requirements : Key1(User)
// class CBuddieNetworkVariable : public CGovernanceObject
// {
// private:
