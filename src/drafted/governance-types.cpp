...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BuddieNetwork") type = BuddieNetwork;
    if(strType == "BuddieNetworkVariable") type = BuddieNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BuddieNetwork) s = "BuddieNetwork";
    if(type == BuddieNetworkVariable) s = "BuddieNetworkVariable";
