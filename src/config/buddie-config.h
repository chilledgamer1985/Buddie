/* src/config/buddie-config.h.  Generated from buddie-config.h.in by configure.  */
/* src/config/buddie-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BUDDIE_CONFIG_H

#define BUDDIE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/buddiecoin/buddie/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Buddie Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Buddie Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "buddiecore"
