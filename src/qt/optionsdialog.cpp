    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BUDDIE-Tan"), QVariant("light"));
    ui->theme->addItem(QString("BUDDIE-Black"), QVariant("drkblue"));
    ui->theme->addItem(QString("BUDDIE-Blue"), QVariant("crownium"));
    ui->theme->addItem(QString("BUDDIE-Chocolate"), QVariant("trad"));
    /* Language selector */
