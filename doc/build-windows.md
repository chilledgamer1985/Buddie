...
Some notes on how to build Buddie Core for Windows.
...
Note that for WSL the Buddie Core source path MUST be somewhere in the default mount file system, for
...
way. This will install to `c:\workspace\bitcoin`, for example:
    ...
    make install DESTDIR=/mnt/c/workspace/buddie # or any other folder name you like
...
It's not possible to build the Buddie Core code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the Buddie Core source code).
