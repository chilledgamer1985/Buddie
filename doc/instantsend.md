...
This mechanism has been integrated into Bitcore-Node-Buddie which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BuddieOfficial/insight-api-buddie#web-socket-api](https://github.com/BuddieOfficial/insight-api-buddie#web-socket-api)
* API: [https://github.com/BuddieOfficial/insight-api-buddie#instantsend-transactions](https://github.com/BuddieOfficial/insight-api-buddie#instantsend-transactions)
...
By default, the Buddie Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Buddie Core daemon:
