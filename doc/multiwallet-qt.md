...
Only requiring some minor changes is buddie.cpp.
...
Changes to buddie.cpp
----------------------
buddie.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
